...
SEGMENT_PROFILES: tuple[SegmentProfile, ...] = (
    ...
    SegmentProfile(
        id="online_education",
        label="Cursos online e infoprodutos",
        keywords=(
            "curso",
            "infoprodut",
            "info produto",
        ...
        offering=OfferingModel.PRODUCTS,
        modules=("clients", "products", "recurring_revenue"),
        terminology=SegmentTerminology(
            clients="Alunos",
            client_singular="aluno",
            catalog="Cursos & Produtos",
            products="Cursos",
            employees="Equipe",
            transactions="Vendas",
        ),
        ...
        kpis=_RETAIL_KPIS,
        integrations=("hotmart", "kiwify", "eduzz", "monetizze"),
        capabilities=frozenset({Capability.RECURRING_REVENUE, Capability.SALES_CHANNELS}),
    ),
    SegmentProfile(
        id="travel_agency",
        label="Agência de viagens e turismo",
        keywords=("viage", "turism", "passage", "excursa", "hotelar", "agencia de viagem"),
        offering=OfferingModel.SERVICES,
        modules=("clients", "services", "employees", "contracts"),
        terminology=SegmentTerminology(
            clients="Passageiros",
            client_singular="passageiro",
            catalog="Pacotes & Serviços",
            services="Pacotes",
            employees="Consultores",
            employee_singular="consultor",
            agenda="Reservas",
            appointment_singular="reserva",
        ...
        kpis=_SERVICE_KPIS,
        integrations=("whatsapp",),
        capabilities=frozenset({Capability.CLIENT_RETENTION, Capability.COMMISSIONS}),
    ),
    SegmentProfile(
