...
def _to_entity(document: CompanyDocument) -> Company:
    return Company(
        ...
        brand_logo=document.brand_logo,
        brand_primary_color=document.brand_primary_color,
        brand_theme=document.brand_theme,
        legal_name=document.legal_name,
        trade_name=document.trade_name,
        cnpj=document.cnpj,
        subsegment=document.subsegment,
        monthly_revenue_cents=document.monthly_revenue_cents,
